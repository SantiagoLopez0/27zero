...
- **`.card-edtech-mentor-arrow`** — bg transparent, border `2px solid #000`, ícono `#000`. En hover de toda la card: border/ícono pasan a `#fff` (bg sigue transparent). Además tiene su **propio** `:hover` (prioridad sobre el de la card): bg `#000`, ícono `#fff`, border `#000`.
