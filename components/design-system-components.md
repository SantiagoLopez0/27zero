...
**El panel es siempre el mismo, sin importar la variante activa del nav** (white/black/scrolled): bg blanco, texto negro, `padding: 1em`, `gap: 0.5em` entre los links/divider, `border: 1px solid rgba(0,0,0,.1)` (`#0000001A`) y un shadow sutil. No cambia de color con la variante — a diferencia del resto del nav, este panel es fijo.
